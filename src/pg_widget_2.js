const cloudName = "dqzj6idvg"; // replace with your own cloud name
...
const myGallery2 = cloudinary.galleryWidget({
  container: "#my-gallery-2",
  cloudName: cloudName,
  mediaAssets: [
    { tag: "gallery2" }, // by default mediaType: "image"
    //{ tag: "gallery2", mediaType: "video" },
    //{ tag: "gallery2", mediaType: "spin" }
  ],
